...
- **Scenario 1: Retrieve Categories**
  - Given the user navigates to the category list
...
- **Scenario 2: No Categories Available**
  ...
  - When the user navigates to the category list
...
## US-005: Edit an Existing Category
...
- **Scenario 1: Retrieve Courses**
  - Given the user navigates to the course list
...
- **Scenario 2: No Courses Available**
  ...
  - When the user navigates to the course list
  - Then the user sees an empty list.
- **Scenario 3: API Retrieval Failure**
  - Given the API is unavailable
...
- **Scenario 1: Update Course**
  ...
  - When the user submits an updated valid course title, description, or category ID
...
- **Scenario 2: Home Navigation from Page Not Found**
  ...
  - When the user requests to navigate home
